...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.Matches(form.Email, validator.EmailRX), "email", "This field must be a valied email address")
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	id, err := app.users.Authenticate(form.Password, form.Email)
	if err != nil {
